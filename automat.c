...
int
fsm_main(const bool *arr, int index, const int len)
{
    enum {
    ...
    state = S0;
    for (;!cancel_for;index++) {
        char c = arr[index % len] ? '1' : '0';
        char* p = &c;
        switch (state) {
            case S0: /* start */
...
endloop:
    ...
    switch (state) {
        ...
        case S147: return 12; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"            12-BYTE*/
        case S156: return 11; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                    11-BYTE*/
        case S165: return 10; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                             10-BYTE*/
        case S174: return 9; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                                     9-BYTE*/
        case S183: return 8; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                                             8-BYTE*/
        case S192: return 7; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                                                     7-BYTE*/
        case S201: return 6; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                                                              6-BYTE*/
        case S210: return 5; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                                                                      5-BYTE*/
        case S219: return 4; /* "1[01]{8}0[01]{8}0[01]{8}0[01]{8}01{10}"                                                                              4-BYTE*/
        case S228: return 3; /* "1[01]{8}0[01]{8}0[01]{8}01{10}"                                                                                      3-BYTE*/
